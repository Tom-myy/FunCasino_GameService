package com.evofun.gameservice.feature.game.api.websocket.exception.handler;

import com.evofun.gameservice.feature.game.api.websocket.connection.WsClient;
import com.evofun.gameservice.feature.game.api.websocket.exception.*;
...
import com.evofun.gameservice.shared.error.*;
...
public class WsExceptionProcessor {
    ...
    public void process(Exception e, WsClient wsClient) {
